			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Jerald Sarte – Web Developer</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Jerald Sarte – Web Developer</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="http://portfolio.local/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
